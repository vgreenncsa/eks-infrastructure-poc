...
resource "aws_network_acl_rule" "cluster_nacl_rule_110" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 110
  egress         = false
  protocol       = 6
...
resource "aws_network_acl_rule" "cluster_nacl_rule_120" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 120
  egress         = false
  protocol       = 6
...
resource "aws_network_acl_rule" "cluster_nacl_rule_130" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 130
  egress         = false
  protocol       = 6
...
# UDP INBOUND
resource "aws_network_acl_rule" "cluster_nacl_rule_140" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 140
  egress         = false
  protocol       = 17
...
resource "aws_network_acl_rule" "cluster_nacl_rule_190" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 190
  egress         = false
  protocol       = 17
...
# ICMP INBOUND
resource "aws_network_acl_rule" "cluster_nacl_rule_150" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 150
  egress         = false
  protocol       = 1
...
# TCP OUTBOUND
resource "aws_network_acl_rule" "cluster_nacl_rule_160" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 160
  egress         = true
  protocol       = 6
...
# UDP OUTBOUND
resource "aws_network_acl_rule" "cluster_nacl_rule_170" {
  network_acl_id = module.vpc.cluster_nacl_id
  rule_number    = 170
  egress         = true
  protocol       = 17
